...
pred_all = dt_sampler.predict_proba_ensemble(X)
...
for alpha in alphas:
    ...
    for run in range(n_run):
        ...
        # Stack "errors" and "accuracies" of tree ensemble over 5 runs
...
if MARGIN:
    ...
    filename = "../results/ds_post_cal_margin.pdf"
else:
    title = "calibration plot (Probability)"
    filename = "../results/ds_post_cal_probability.pdf"
